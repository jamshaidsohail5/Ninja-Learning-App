...
public class MenuFortest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_fortest);


        img = (ImageView) findViewById(R.id.soundontest);
        myService = new Intent(MenuFortest.this, MusicRunningService.class);
    ...
    public void change_the_sound_icon_2(View v)
    {
